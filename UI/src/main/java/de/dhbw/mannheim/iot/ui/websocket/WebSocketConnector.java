...
public class WebSocketConnector {
    ...
    public WebSocketConnector(Class<? extends WebSocketHandler> clazz, String ressourceString, int port) {
        ...
        b.resource(clazz).resource("./webapps").resource("./src/main/resources"+ressourceString).resource("./UI/src/main/resources"+ressourceString).resource("/Users/tarek/IntellijProjects/IoTProjekt/UI/src/main/resources" + ressourceString).port(port).host("localhost").build();
